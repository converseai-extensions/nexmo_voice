...
function updateLinkNumbers(api_key, api_secret, application_id, inboundURI, link_numbers) {

  if (!link_numbers) {
    return;
  }

  for (var i = 0; i < link_numbers.length; i++) {

    var linkNumber = link_numbers[i];
    var msisdn = linkNumber.msisdn;
    var country = linkNumber.country;
    ...
    var options = {
      ...
      form: {
        ...
        voiceStatusCallback: inboundURI + "?action=number"
      },
